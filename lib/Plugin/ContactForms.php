			...
			foreach($contactformfields as $field)
			{
				...
				if($pos===false){
					...
					if($fieldid=='telephonenumber'){
					   ...
					   $telephone1=sanitize_text_field($_POST['telephonenumber1']);
					   
						if(isset($telephone1) && $telephone1!==""){
							
							$submittedformvalues[$fieldid]= sanitize_text_field($_POST['telephonenumber1']).sanitize_text_field($_POST['telephonenumber2']).sanitize_text_field($_POST['telephonenumber3']);
						}
