...
if($hrjobsform['confmsg_pagemode']=="same"){
    echo  '<form id="'.$hrjobsform[name].'_hrjobsforms" class="awp_hrjobs_form abswpjfm" name="'.$hrjobsform[name].'_hrjobsforms" action="'.$_SERVER['REQUEST_URI'].'" method="post" enctype="multipart/form-data">';
}
elseif($hrjobsform['confmsg_pagemode']=="other")
{
    ...
    echo  '<form id="'.$hrjobsform[name].'_hrjobsforms" class="awp_hrjobs_form abswpjfm" name="'.$hrjobsform[name].'_hrjobsforms" action="'.SITE_URL.'/'.$page_action.'" method="post" enctype="multipart/form-data">';
}
...
foreach($formfields as $field)
{
	...
	switch($fieldtype)
	{
		...
		case "select":
			...
			break;
		case "file":
			echo '<input type="file" id="file_upload" name="file_upload" class="absp_jobapplicant_input_text'.$validateclass.'" />';
